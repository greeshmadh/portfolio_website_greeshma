...
import AP from "/src/assets/AP1.jpg";
import ELT from "/src/assets/elt.png";
import meeting from "/src/assets/meeting.jfif";
            ...
            <div>
              ...
              <div className="space-y-0.5">
                ...
                <a 
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="text-black text-sm flex items-center gap-1 hover:text-[#1B3C53] transition-colors break-all"
                >
                  <SiLinkedin size={18} />
