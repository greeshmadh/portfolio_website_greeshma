...
function ProjectSection() {
  ...
  return (
    <section className="min-h-screen h-auto md:h-screen bg-gradient-to-br from-[#1B3C53] via-[#234C6A] via-[#456882] to-[#E3E3E3] flex items-center justify-center px-4 sm:px-8 py-12 md:py-0 snap-start">
      <div className="max-w-7xl mx-auto w-full">
        <div className="mb-6 sm:mb-8">
          <h2 className="inline-block bg-[#E3E3E3] text-black text-3xl sm:text-4xl md:text-5xl font-bold px-6 sm:px-12 py-4 sm:py-6 border-4 border-black">
            PROJECTS
          </h2>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 md:gap-8">
          {projects.map((project, index) => (
            <div 
              ...
              className="bg-[#456882] rounded-lg overflow-hidden cursor-pointer hover:bg-[#234C6A] transition-all duration-300 hover:scale-105 shadow-lg border-4 border-black"
            >
              <div className="bg-[#E3E3E3] h-48 sm:h-56 md:h-64 flex items-center justify-center">
                {project.image ? (
                  <img 
                    src={project.image} 
                    alt={project.title}
              ...
              <div className="p-4 sm:p-6 text-center">
                <h3 className="text-white text-lg sm:text-xl md:text-2xl font-semibold uppercase mb-2 sm:mb-3">
                  {project.title}
                </h3>
                <p className="text-[#E3E3E3] text-sm sm:text-base md:text-lg leading-relaxed">
                  {project.description}
                </p>
              </div>
            </div>
